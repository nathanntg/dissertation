...
% TODO: select one
In three animals, an additional craniotomy was made, contralateral to 
...
\caption{\textbf{Detection of fluorescent agent in vasculature via implanted fibers.} At
...
\caption{\textbf{Cortical spreading depolarization (CSD) evokes a fluorescence 
...
\caption{\textbf{Frames of polished imaging surface show progression of cortical 
...
\caption{\textbf{During forepaw stimulation, two 37~\si{\micro\meter} fibers show time 
