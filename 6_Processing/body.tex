...
implanted in nine animals. Of those, we recorded from seven 
chronically via the fiber interface described in the next section; 
two were excluded due to issues in early design iterations, 
...
perform chronic recordings in awake behaving animals. 
